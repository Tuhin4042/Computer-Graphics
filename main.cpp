...
/*
	glColor3f(0.42, 0.875, 0.969);
	circle(100,30, 950, 50);
...
// tree 2 from here
    ...
    int xtree2 = 285,tree2 = 77;

    glBegin(GL_POLYGON);           // tree trunk
    glColor3f(0.49, 0.29, 0);
    glVertex2i(100 + xtree2, 420 + tree2);
    glVertex2i(180 + xtree2, 420 + tree2);
    glVertex2i(180 + xtree2, 700 + tree2);
    glVertex2i(100 + xtree2, 700 + tree2);
    glEnd();

    glBegin(GL_POLYGON);           // tree root
    glColor3f(0.49, 0.29, 0);
    glVertex2i(70 + xtree2, 380 + tree2);
    glVertex2i(210 + xtree2, 380 + tree2);
    glVertex2i(190 + xtree2, 400 + tree2);
    glVertex2i(180 + xtree2, 420 + tree2);
    glVertex2i(100 + xtree2, 420 + tree2);
    glVertex2i(90 + xtree2, 400 + tree2);
    glEnd();


    glBegin(GL_TRIANGLES);           // tree root design
    glColor3f(0.945, 0.796, 0.471);
    glVertex2i(100 + 40 + xtree2, 380 + tree2);
    glVertex2i(120 + 40 + xtree2, 400 + tree2);
    glVertex2i(140 + 40 + xtree2, 380 + tree2);
    glEnd();

    glBegin(GL_TRIANGLES);           // tree root design
    glColor3f(0.945, 0.796, 0.471);
    glVertex2i(100 + xtree2, 380 + tree2);
    glVertex2i(120 + xtree2, 400 + tree2);
    glVertex2i(140 + xtree2, 380 + tree2);
    glEnd();

    glColor3f(0.506, 0.671, 0.243); // tree2 leaf

    circle(50,70,370,750);
    circle(50,70,480,750);
    circle(40,70,400,820);
    circle(50,50,415,760);
    circle(50,40,470,840);
*/
...
glColor3f(0, 0, 0);
   ...
   // day night sun and star
    ...
    circle(50, 50, 1700, 900);

    if (isDay)
    {
        glColor3f(0.878, 0.949, 0.988);  // White for moon
  ...
  //  circle(50, 50, 1700, 900);
   ...
   // drawGrass(-1400, -90);
    ...
    glColor3f(0.537, 0.275, 0.063);
        ...
        glColor3f(0.98, 0.922, 0.624);
        glVertex2i(1652, 400);
        glVertex2i(1668, 400);
        glVertex2i(1668, 395);
        glVertex2i(1652, 395);

        glVertex2i(1652, 400-30);
        glVertex2i(1668, 400-30);
        glVertex2i(1668, 395-30);
        glVertex2i(1652, 395-30);

        glVertex2i(1652, 400-60);
        glVertex2i(1668, 400-60);
        glVertex2i(1668, 395-60);
        glVertex2i(1652, 395-60);
*/
